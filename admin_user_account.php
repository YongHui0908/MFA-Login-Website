<?php
session_start();
require 'user_account_backend.php';
...
<head>
  ...
  <title>User Account | Online University Examination</title>
        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <p>Below is a detailed list of registered users, including their contact information, national ID, course of study, and home address.</p>
                ...
                <tbody>
                  <?php foreach ($userAccounts as $account): ?>
                    <tr>
                        ...
                        <td><?php echo htmlspecialchars($account['nationalid']); ?></td>
                        <td><?php echo htmlspecialchars($account['course']); ?></td>
                        <td><?php echo htmlspecialchars($account['homeaddress']); ?></td>
                    </tr>
                  <?php endforeach; ?>
                </tbody>
              </table>
