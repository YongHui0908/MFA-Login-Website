              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo htmlspecialchars($profile['course']); ?></div>
                  </div>
                ...
                <div class="tab-pane fade profile-edit pt-3" id="profile-edit">
                  ...
                  <input type="hidden" name="userid" value="<?php echo htmlspecialchars($_SESSION['user_id']); ?>">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="phonenumber" type="tel" class="form-control" id="phonenumber" value="<?php echo htmlspecialchars($profile['phonenumber']); ?>" >
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      <label for="nationalid" class="col-md-4 col-lg-3 label">Course</label>
                      <div class="col-md-8 col-lg-9">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                      <textarea name="homeaddress" class="form-control" id="homeaddress" rows="4" ><?php echo htmlspecialchars($profile['homeaddress']); ?></textarea>
                      </div>
                    </div>
